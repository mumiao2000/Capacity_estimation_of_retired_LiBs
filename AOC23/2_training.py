...
def get_dataloader(csv, is_train=False):
    ...
    X = torch.tensor(df.iloc[:, :-1].values, dtype=torch.float32).reshape(-1, 2, int(r * 2563))
...
for i in tqdm.tqdm(range(epochs)):
    ...
    print('Train RMSE Loss: ', train_rmse_loss * 11.4666)
    print('Train MAE  Loss: ', train_mae_loss * 11.4666)
    print('Train MAPE Loss: ', train_mape_loss * 100)
    print('Valid RMSE Loss: ', valid_rmse_loss * 11.4666)
    print('Valid MAE  Loss: ', valid_mae_loss * 11.4666)
...
if need_test:
    ...
    print('Test  RMSE Loss: ', test_rmse_loss * 11.4666)
    print('Test  MAE  Loss: ', test_mae_loss * 11.4666)
